...
runif(n = 10)
  ## 0.60347317 0.98582932 0.88585956 0.99592248 0.40411085 0.13480548 0.07372239 0.54094102 0.56727435 0.24399100
...
runif(n = 10)
  ## 0.9843500 0.4140856 0.1807576 0.2996149 0.2991096 0.1380046 0.3329014 0.2574787 0.2872726 0.1070232
...
dt_model_fit_1 <- 
  dt_model |> 
  fit(data = data_train,
      Price ~ Mileage + Doors + Cylinder + Cruise)
...
ggplot(data = dt_model_pred_res) + 
  geom_point(mapping = aes(x = Price, y = .pred))
